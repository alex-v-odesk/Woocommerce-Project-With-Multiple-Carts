...
<h2 class="woo-lost-password">Reset Password</h2>
	<p><?php echo apply_filters( 'woocommerce_reset_password_message', __( 'Enter a new password and click SAVE to reset your password.', 'woocommerce' ) ); ?></p>

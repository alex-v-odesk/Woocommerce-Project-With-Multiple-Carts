...
<h1 class="rptitle">Recent Orders</h1>
<?php if ( $has_orders ) : ?>
<?php
...
<?php else : ?>
	<div class="woocommerce-message woocommerce-message--info woocommerce-Message woocommerce-Message--info woocommerce-info" style="text-align:center;">
       <div class="row text-center">
           <div class="col-md-12"><p><?php _e( 'No order has been made yet.', 'woocommerce' ); ?></p></div>
        <div class="col-md-12">
            <a style="float:none;" class="woocommerce-Button button wc-backward" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>">
...
.woocommerce-info::before {
    ...
    .woocommerce-info p{font-size: 25px; color: #000;}
    a.button.wc-backward:after{top: 10px;}
    a.button.wc-backward:hover::after{top: 10px;}
</style>
...
<style type="text/css">
    .banner_about_bottom{display: none;}
</style>

<?php if( is_product_category() && rp_has_child()) { ?>
<style>
.banner_about_bottom{display: block;}
</style>
<?php } ?>

<?php if(is_search()):?>
        <hr style="margin:20px 0px 5px;background: #ddd; height: 2px;">
...
<?php endif;?>
	...
	<?php //if(rp_has_child())echo "Has child";else echo "No child";?>

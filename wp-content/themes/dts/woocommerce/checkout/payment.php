...
<div id="payment" class="woocommerce-checkout-payment">
	...
	<hr style="height:1px; background:#AEA198;margin:10px 0px 20px;">
-	<h1 class="rpsubtitle-small">Payment Options</h1>
	...
	<div class="form-row place-order">
		...
		<?php echo apply_filters( 'woocommerce_order_button_html', '<input type="submit" class="button alt rpbutton-black" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '" />' ); ?>
